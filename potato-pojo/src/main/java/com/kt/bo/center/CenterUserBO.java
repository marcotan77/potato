...
public class CenterUserBO {
    ...
    @Email
    @ApiModelProperty(value = "邮箱",name = "email",example = "test@test.com",required = true)
    private String email;
    @ApiModelProperty(value = "性别",name = "sex",example = "0：女 1：男 2：保密",required = true)
    private Integer sex;
    @ApiModelProperty(value = "生日",name = "birthday",example = "2020-1-5",required = true)
